...
- [ ] Создать pages/catalog/ui — страница каталога
- [ ] Создать widgets/product-card/ui — карточка: фото, название, цена, остаток, дата доставки
- [ ] Отображать сетку карточек при загрузке страницы
- [ ] Реализовать infinite scroll через IntersectionObserver
- [ ] При скролле вниз — подгружать следующую страницу из API
- [ ] Проверить: 100+ карточек подгружаются порциями по 20
